    ...
    <section id={id} className="min-h-screen py-20 relative z-10 bg-black/20">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="mt-4 text-gray-400">Selected projects that define my career</p>
        </motion.div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                    {project.tech.map(t => (
                        <span key={t} className="text-xs font-mono bg-white/5 px-2 py-1 rounded text-gray-300 border border-white/5">
                            {t}
                        </span>
                    ))}
                </div>
                ...
                <div className="flex gap-4">
                    ...
                    <a href="#" className="flex items-center gap-2 text-sm font-semibold text-gray-500 hover:text-white transition-colors">
